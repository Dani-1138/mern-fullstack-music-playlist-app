...
import './App.css'
import { Left, LogoImg, SongNo,MusicImg, MusicList, MusicNo, MusicSubTitle, MusicTitle, PlayListDiv, PlayListList, PlayListSpan, PlayListTitle, SongList, SongListCard } from './components/leftside/left'
import { createGlobalStyle } from 'styled-components'
import styled from 'styled-components'
import { Right } from './components/rightside/right'
import { PlayCircleFilled, SkipPrevious, SkipNext, Pause, VolumeUp, Forward30 } from '@mui/icons-material'
import SearchSong from './components/rightside/search'
import Widgetcard, { WidgetWrapper } from './components/rightside/widgetcard'
import { ControlDiv, MainControls, MainPlayWave } from './components/rightside/musicControl'
import { IconWrapper, BottomPlayBar, MusicBottomImg, MusicBottomSubTitle, MusicBottomTitle, Pauses, PlayWave, SkipNexts, SkipPreviouss, TimeFinish, TimerBar, TimerWrapper, TimeStart, VolumeWrapper, BottomControl } from '../src/components/bottom/bottom'
      ...
      <FullScreen>
        ...
        <Wrapper1>
          ...
          <Left>
            ...
            <PlayListDiv>
            <PlayListList>
            <PlayListSpan><FaHome /></PlayListSpan><NavLink to='/'>Home</NavLink>
          </PlayListList>
              <PlayListList>
                <PlayListSpan><RiPlayListFill /></PlayListSpan><NavLink to='playlist'>Playlist</NavLink>
              </PlayListList>
              <PlayListList>
                <PlayListSpan><BsFillPersonLinesFill /></PlayListSpan><NavLink to='get-recent'> New released</NavLink>
              </PlayListList>
              <PlayListList>
