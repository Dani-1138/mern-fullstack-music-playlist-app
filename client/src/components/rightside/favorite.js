  ...
  return (
    <>
      {data && data.filter((data) =>
        ...
        data.name.toLowerCase().includes(search))).map((song, i) =>
        (
          song.favorite === true && <MainDiv key={song._id} className="song-card-hover" onClick={() => setCurrentPlaySong(i)} >
            ...
            <FavoriteDiv className="favor-div">
              ...
              {song.favorite ? <FavoriteTrue onClick={() => editFavorite(song._id, !song.favorite)} /> : <FavoriteIcon onClick={() => editFavorite(song._id, !song.favorite)} />}
